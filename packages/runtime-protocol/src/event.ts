...
export type AgentEvent =
  ...
  | { readonly type: "message.completed"; readonly runtimeId: RuntimeId; readonly sessionId: SessionId; readonly messageId: string; readonly text: string; readonly at: Timestamp }
  | { readonly type: "tool.started"; readonly runtimeId: RuntimeId; readonly sessionId: SessionId; readonly toolName: string; readonly callId?: string; readonly args?: unknown; readonly at: Timestamp }
  | { readonly type: "tool.completed"; readonly runtimeId: RuntimeId; readonly sessionId: SessionId; readonly toolName: string; readonly callId?: string; readonly result?: unknown; readonly error?: string; readonly at: Timestamp }
  | { readonly type: "permission.requested"; readonly runtimeId: RuntimeId; readonly sessionId: SessionId; readonly action: string; readonly detail?: unknown; readonly at: Timestamp }
  ...
  | { readonly type: "artifact.emitted"; readonly runtimeId: RuntimeId; readonly sessionId: SessionId; readonly artifact: ArtifactRef; readonly at: Timestamp }
